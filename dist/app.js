import { changeTab, changePage, changeContent, getTheWindowLocation, TurnOnOffElement, scrollFunction, scrollToTop, } from "./functions.js";
import { mainBtns, main, moreBtn, moreContent, popUpMenu, menuBtn, headerContainer, smallMenuUl, logo, mainTextPopUp, backToTopBtn, } from "./DOMElements.js";
// I somehow cannot export this from DOMElements -> bcs of the getTheWindowLocation()
const currentPage = document.querySelectorAll(`[data-id="${getTheWindowLocation()}"]`);
